...
class MyToDo(Tk):
    def __init__(self):
        ...
        startshift = Label(self, text='Start', command=lambda :self.show_frame('Start'))
        homeworkshift = Label(self, text='Homework', command=lambda :self.show_frame('Homework'))
        programmingshift = Label(self, text='Programming', command=lambda :self.show_frame('Programming'))

        startshift.grid(row=1, column=1)
        homeworkshift.grid(row=2, column=1)
        programmingshift.grid(row=3, column=1)
