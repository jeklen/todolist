...
class Homework(Frame):
    ...
    def __init__(self, parent, controller):
        ...
        frame3 = BottonMenu(self, controller)

class Title(Frame):
    """the title frame for Homework, etc"""
...
class BottonMenu(Frame):
    """the botton of Homework, etc"""
    def __init__(self, parent, controller):
        Frame.__init__(self, parent) 
        button1 = Button(self, text="Go to the start Page",
            command=lambda: controller.show_frame("DoItNowOrNever"))       
        button2 = Button(self, text="Add", command=lambda: getTask)
